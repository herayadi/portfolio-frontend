/* ============================================
   CONTACT — Form Handling and Social Links
   ============================================ */
...
const Contact = (() => {
   ...
   */
  function init(data) {
    if (!linksContainer || !data.personal) return;
    
    _renderLinks(data.personal);
    _bindEvents();
    ...
    if (personalData.email) {
      html += `
        <a href="mailto:${personalData.email}" class="social-link" target="_blank" rel="noopener noreferrer">
          <div class="social-icon">${icons.email}</div>
    ...
    if (personalData.linkedin) {
      html += `
        <a href="${personalData.linkedin}" class="social-link" target="_blank" rel="noopener noreferrer">
          <div class="social-icon">${icons.linkedin}</div>
          <span>${personalData.linkedin.replace('https://', '')}</span>
        </a>
      `;
    }
    ...
    if (personalData.github) {
      html += `
        <a href="${personalData.github}" class="social-link" target="_blank" rel="noopener noreferrer">
          <div class="social-icon">${icons.github}</div>
    ...
    if (personalData.location) {
      html += `
        <div class="social-link">
          <div class="social-icon">${icons.location}</div>
