...
const DATA = {
  personal: {
    ...
    avatarUrl: "assets/images/heri.webp",
    cvUrl: "assets/files/HeriRahmat_CV.pdf",
  ...
  experience: [
    {
      ...
      techs: ["Project Management", "Enterprise Architecture", "API Strategy", "SDLC"],
    },
    {
      ...
      techs: ["Java", "API Gateway", "Integration Server", "Kafka", "SQL Server"],
    },
    {
      ...
      techs: ["webMethods Integration Server", "Microservices Runtime", "Bitbucket", "SQL Server", "Postman"],
    },
    {
      ...
      techs: ["webMethods", "TIBCO BusinessWorks", "WSO2", "MySQL", "Oracle", "PHP", "Laravel"],
    },
  ],
  ...
  projects: [
    {
      ...
      techs: ["webMethods IS", "JDBC Adapter", "MySQL", "Oracle"],
    ...
    },
    {
      ...
      techs: ["WSO2", "webMethods", "PHP", "Laravel", "REST API"],
